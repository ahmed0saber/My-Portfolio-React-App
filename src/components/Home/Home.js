                ...
                <section className="container home">
                    <section className="resizable">
                        ...
                        <section className="home-btns">
                            <a rel="noreferrer" target="_blank" href="https://drive.google.com/u/0/uc?id=178jblY_cz9uPzve34L1xmj0YxmlAKfND&export=download"><button className="cp-btn">Download My Resume</button></a>
                        </section>
                    </section>
                </section>
            </main>
